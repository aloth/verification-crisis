...
This codebook documents \textbf{Wave~2} of the longitudinal expert survey on
generative-AI--driven disinformation ($N=54$, July 2025 -- March 2026).
The survey is cumulative: Wave~2 reports the full sample collected to date and
therefore includes all 21 Wave~1 respondents (July -- December 2025), plus 33
further responses. The waves are not disjoint samples and their totals must not
be added together. See the repository README for the wave overview.

It complements the survey instrument
...
(\texttt{doi:10.7910/DVN/BXO2QA}, open, CC0~1.0). The response data is also
deposited at Zenodo under the concept DOI
\texttt{doi:10.5281/zenodo.18703600}, which always resolves to the current
version. Both deposits are privacy-reduced and neither carries the identity
columns. Access to the Zenodo deposit is granted on request for academic
research, following the consent under which the responses were given:
redistribution outside a requesting research context was not part of what
respondents agreed to. The Wave~1 analysis cites the version DOI
\texttt{doi:10.5281/zenodo.18703601}, which stays valid. The survey
instrument is reproduced in full in
